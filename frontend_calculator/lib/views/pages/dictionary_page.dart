...
class DictionaryPage extends StatelessWidget {
  ...
  final List<Map<String, String>> solarTerms = [
    {
      ...
      'definition': 'Urządzenie przekształcające energię słoneczną na energię elektryczną za pomocą zjawiska fotowoltaicznego.'
    },
    {
      'term': 'Inwerter',
      'definition': 'Urządzenie zmieniające prąd stały (DC) produkowany przez panele na prąd zmienny (AC) używany w domowych instalacjach.'
    },
    {
      'term': 'Net-metering',
      'definition': 'System rozliczania energii, który pozwala właścicielom paneli słonecznych oddawać nadmiar prądu do sieci i odbierać go później.'
    },
    {
    ...
    {
      'term': 'Cień',
      'definition': 'Element mający wpływ na produkcję energii – nawet częściowe zacienienie może znacząco zmniejszyć wydajność systemu.'
    },
    {
      'term': 'Kąt nachylenia',
    ...
    },
    {
      ...
      'definition': 'Akumulator lub system baterii służący do przechowywania energii elektrycznej do późniejszego użycia.'
    },
    {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Słownik Fotowoltaiki')),
